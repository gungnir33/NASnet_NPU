...
parser.add_argument('-a', '--arch', metavar='ARCH', default='resnet18',
                    choices=model_names,
                    help='pretrainedmodels architecture: ' +
                        ' | '.join(model_names) +
                        ' (default: resnet18)')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.pretrained:
        print("=> using pre-trained pretrainedmodels '{}'".format(args.arch))
        model = pretrainedmodels.__dict__[args.arch](num_classes=1000,
                                                     pretrained=args.pretrained)
    else:
        print("=> creating pretrainedmodels '{}'".format(args.arch))
    ...
    ###### modify npu_p1 2 end ######
        ...
        #     model.cuda()
        # else:
        #     # pretrainedmodels = torch.nn.DataParallel(pretrainedmodels).cuda()
        #     model = model.to(loc)
